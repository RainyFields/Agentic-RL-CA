#!/bin/bash
# Wave-3 HCAPO ablation (user-approved 2026-07-27): omega=0.5 (arm b1). Qwen3-4B, NON-thinking @2048, 500 steps.
...
exec env MODEL_PATH=/mnt/hdfs/mlsys/models/Qwen3-4B COND=hcapo_w05 SEED=0 PROTOCOL=4turn_nothink2k \
