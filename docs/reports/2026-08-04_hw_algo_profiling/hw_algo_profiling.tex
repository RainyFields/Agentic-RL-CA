...
\multicolumn{7}{c}{\textbf{turn-PPO}, matched early steps, mean}\\
phase & H100 s & share & B200 s & share & wall ratio & per-token\\\midrule
\matchedturnppo
\bottomrule\end{tabular}\par\vspace{0.8em}
\begin{tabular}{lrrrrrr}\toprule
\multicolumn{7}{c}{\textbf{GRPO}, matched early steps, mean}\\
phase & H100 s & share & B200 s & share & wall ratio & per-token\\\midrule
\matchedgrpo
\bottomrule\end{tabular}
