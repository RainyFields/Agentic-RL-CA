...
The lift$\times$answer cell completed after this report was first compiled: final val-EM $0.411$ at
the cap (2047 tokens, clip $\approx$1.0), confirming its $\sim$step-375 ignition; its full-set
number will be appended when its eval lands.
